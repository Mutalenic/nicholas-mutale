  ...
  return (
    <div id="work" className="w-full">
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <div className="grid">
          <div className="grid md:grid-cols-2 py-16 bg-[#ffffff] dark:bg-gray-800 rounded-2xl">
            <WorkItem
              title="Air Quality"
            ...
            <Description
              ...
              app you will be able to see the current air quality data and
          ...
          <div className="grid md:grid-cols-2 py-16 dark:bg-gray-900">
            <WorkItem
              title="Moviespace"
